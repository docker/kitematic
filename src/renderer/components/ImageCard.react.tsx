...
export default React.createClass({
	...
	render() {
		...
		if (this.state.loading) {
			...
			let tagDisplay = this.state.tags.filter((tag) => tag.name.includes(this.state.searchTag)).map((tag) => {
				let t = "";
				if (tag.name) {
					t = tag.name;
				} else {
