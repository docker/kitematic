...
import ContainerProgress from '../renderer/components/ContainerProgress.react.jsx';
...
export default React.createClass({
    ...
    render: function () {
        ...
        if (this.props.container.Error) {
            ...
            body = (<div className="details-progress error">
            ...
            if (this.props.container.Progress) {
                ...
                body = (<div className="details-progress">
            ...
            var logWidget = (<ContainerHomeLogs container={this.props.container}/>);
            var webWidget;
            if (this.showWeb()) {
                webWidget = (<ContainerHomePreview ports={this.props.ports} defaultPort={this.props.defaultPort}/>);
            }
            var folderWidget;
            if (this.showFolders()) {
                folderWidget = (<ContainerHomeFolders container={this.props.container}/>);
            }
            if (logWidget && !webWidget && !folderWidget) {
                body = (<div className="details-panel home">
...
//# sourceMappingURL=ContainerHome.react.jsx.map