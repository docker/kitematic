...
export default React.createClass({
    ...
    handleChangeStartLinkedContainers(e) {
        let checked = e.target.checked;
        this.setState({
    ...
    render() {
        ...
        if (process.platform !== "linux") {
            ...
            if (!util.isNative()) {
                vmShutdown = (<div className="option">
						<div className="option-name">
...
//# sourceMappingURL=Preferences.react.jsx.map