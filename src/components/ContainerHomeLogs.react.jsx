...
const FontSelect = React.createClass({
    ...
    render: function () {
        return (<select className='logs-font-size__select' value={this.props.fontSize} onChange={this.props.onChange}>
...
export default React.createClass({
    ...
    render: function () {
        ...
        return (<div className="mini-logs wrapper">
...
//# sourceMappingURL=ContainerHomeLogs.react.jsx.map