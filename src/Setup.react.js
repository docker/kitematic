      ...
      <div className="setup">
        ...
        <div className="desc">
          <div className="content">
            ...
            <p><button className="btn btn-action" onClick={this.handleErrorRetry}>Retry Setup</button></p> <p><button className="btn btn-action" onClick={this.handleErrorRemoveRetry}>Delete VM and Retry Setup</button></p>
          </div>
        </div>
      </div>
    );
